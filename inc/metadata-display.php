...
/**
 * Construct the html structure of the manage metadata page
 *
 * @since 1.0.4
 * @return void
 */
function coe_am_metadata_display() {
	...
	?>
	<div class="wrap">
		<h1><?php esc_html_e( get_admin_page_title(), $_coe['text'] ); ?></h1>
		<div class="container-fluid metadata-container" id="poststuff" style="margin-top: 30px;">
			<div class="row">
				<div class="col-md-4 new-metadata-col">
				...
				<div class="col-md-8 metadata-table-col">
					<table class="wp-list-table widefat fixed striped table-view-list tags">
						...
						if ( $taxes ) {
							foreach ( $taxes as $tax ) {
								...
								<tr>
									<td>
										<a href="<?php echo admin_url( 'edit-tags.php?taxonomy=' . $tax->name ); ?>"><strong><?php echo esc_attr( $tax->label ); ?></strong></a>
										<br>
